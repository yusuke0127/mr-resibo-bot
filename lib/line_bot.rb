...
class LineBot
  ...
  ACCEPTED_KEYWORDS = {
    ...
    'kris': ['BOOM DAGA!', 'Tawag ka barbero', 'May magpapagupit daw oh'],
    ...
    'ベル': ['Ayan ba yung malibog pa sa daga?', 'Kririn!', 'Hi! Kuya Jobs!', 'Yobabs!', 'Kuya Doods!', 'Hi Dodi!'],
    'bern': ['Ayan ba yung malibog pa sa daga?', 'Kririn!', 'Hi! Kuya Jobs!', 'Yobabs!', 'Kuya Doods!','Hi Dodi!'],
    'bye': ['Hug mo ko!'],
